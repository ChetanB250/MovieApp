...
const Header = () => {
    ...
    return (
    <header>
        <nav className="bg-white border-b-2 border-gray-200 dark:bg-gray-900 dark:border-b-2 dark:border-gray-900 p-3">
          <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto py-4">
            <Link to="" className="flex items-center">
                <img src={Logo} className="h-12 w-12 mr-3" alt="CineMate Logo" />
